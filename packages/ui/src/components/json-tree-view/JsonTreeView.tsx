    ...
    >
      <div className="dr-json-line">
        {containerLike && !empty ? (
          ...
          >
            {/* Pinned literal: .dr-json-chevron (json-tree-view.css) is a
                fixed h-4 w-4 slot that does not follow the font-size axis;
                the token's growth leaves almost no margin at
                large/extra-large. */}
            <ChevronRight
              className={cn(
