        ...
        <div className="flex items-center justify-center py-8">
          ...
          >
            {[
              ...
              <div
                key={token}
                className={`${token} border-border ring-border/50 relative rounded-lg border px-5 py-4 ring-1`}
                style={{
...
<div className="bg-surface-header">header — top bar</div>`}
      >
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-surface-sidebar ring-border flex h-20 flex-col justify-end rounded-lg p-4 ring-1">
            <p className="font-mono text-xs font-medium text-white">sidebar</p>
            <p className="font-mono text-[10px] text-white/60">
              var(--surface-sidebar)
            </p>
          </div>
          <div className="bg-surface-header ring-border flex h-20 flex-col justify-end rounded-lg p-4 ring-1">
...
<div className="ring-2 ring-primary">ring-2 ring-primary</div>`}
      >
        <div className="flex flex-wrap gap-4">
          ...
          <div className="ring-border rounded-lg p-4 text-sm ring-1">
            ring-1 ring-border
          </div>
          <div className="ring-primary rounded-lg p-4 text-sm ring-2">
            ring-2 ring-primary
          </div>
          <div className="ring-destructive rounded-lg p-4 text-sm ring-2">
