...
const COMPONENTS = [
  ...
  },
  {
    ...
    label: "Clipboard",
    description: "Copy-to-clipboard control with success-state feedback",
    icon: ClipboardCopy,
  },
  {
  ...
  },
  {
    ...
    label: "Combobox",
    description: "Searchable input with dropdown listbox and keyboard nav",
    icon: Search,
  },
  {
  ...
  },
  {
    ...
    label: "Date Picker",
    description: "Date input with calendar popover, range mode, and presets",
    icon: CalendarRange,
  },
  {
  ...
  {
    href: "/components/editable",
    label: "Editable",
    description: "Click-to-edit text with submit-on-blur and explicit controls",
    icon: Pencil,
  },
  {
  ...
  },
  {
    ...
    label: "File Upload",
    description: "Drag-and-drop multi-file upload with previews and validation",
    icon: Upload,
  },
  {
  ...
  },
  {
    ...
    label: "Highlight",
    description: "Inline text highlighting for search results and emphasis",
    icon: Highlighter,
  },
  {
  ...
  },
  {
    ...
    label: "Number Input",
    description: "Numeric input with steppers, locale formatting, and clamp",
    icon: Hash,
  },
  {
  ...
  },
  {
    ...
    description: "Password field with show/hide toggle and a11y announcement",
    icon: Lock,
  },
  {
  ...
  },
  {
    ...
    label: "QR Code",
    description: "SVG QR generator with logo overlay and theme-aware colors",
    icon: QrCodeIcon,
  },
  {
  ...
  },
  {
    ...
    label: "Segment Group",
    description: "iOS-style segmented control with animated indicator pill",
    icon: Rows3,
  },
  {
  ...
  },
  {
    ...
    label: "Steps",
    description: "Wizard / stepper with content slots and linear gating",
    icon: ListOrdered,
  },
  {
    href: "/components/swap",
    label: "Swap",
    description: "Crossfade between two children driven by a pressed boolean",
    icon: Repeat,
  },
  {
  ...
  },
  {
    ...
    label: "Tags Input",
    description: "Chip-based tag entry with paste-split and validation",
    icon: Tags,
  },
  {
    href: "/components/timer",
    label: "Timer",
    description: "Stopwatch and countdown with start, pause, resume, and reset",
    icon: TimerIcon,
  },
  {
