        ...
        <Accordion type="multiple" className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              <code className="font-mono text-xs">type="multiple"</code> you can
              open this item independently of the others.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger>Section Two</AccordionTrigger>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="billing">
            ...
            <AccordionContent>
              ...
              billing details and update your card information to avoid service
              interruption.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="notifications">
            ...
            <AccordionContent>
              ...
              preferences to control which events send alerts and through which
              channels.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="security">
            ...
            <AccordionContent>
              ...
              enabled and no suspicious login attempts have been detected in the
              last 30 days.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
